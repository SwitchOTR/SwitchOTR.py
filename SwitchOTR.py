...
name = raw_input ("\033[91mAp ka Nama ?(SwitchOTRName Real) : ")																	

																	

if name == (""):																	

     print '\x1b[1;92mReal Nama istmal karain Switch OTR :V'																	
...
if password == ("08053183097"):																	
     ...
     print 'Welcome ' + name + ' SwitchOTR'																	

     time.sleep(0.8)																	

     print 'Semoga beruntung ' + name + ' SwitchOTR'																	
     ...
     print 'Thanks To: BLESSING NSIEGBE'																	

     time.sleep(0.8)																	

     print 'HamiiHacker ' + name + ' Agar Facebook  tools Galat ho gaya  <https://www.facebook.com/HAMID.TERABAAP06>'																	
     ...
     print ("Ap ka Darj kia Gia password Galat ha HamiIHacker sy help lain (09011370403)")																	
